...
if(isset($_POST['update']))
{
    ...
    $query="UPDATE donors SET d_name='$_POST[name]',d_phno='$_POST[phno]',d_dob='$_POST[dob]',gender='$_POST[gender]',d_address='$_POST[address]',age='$_POST[age]',weight='$_POST[weight]',bp='$_POST[bp]',hemoglobine='$_POST[hemoglobine]',blood_type='$_POST[bloodtype]' where d_id='$d_id'";
    $query_run=mysqli_query($conn,$query);
